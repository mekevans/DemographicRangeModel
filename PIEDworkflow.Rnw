...
These data files could then be imported to create plot of the climate -- vital rate relationships:

\section{Questions}
\subsection{\emph{dataPrepRecruitment.R}, lines 32 and 45-53}
What exactly is CONDID, and what needs to be done with it?
