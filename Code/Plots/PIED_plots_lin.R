...
grow_c_d <- ggplot(data=grdata,aes(x=PREVDIA))+
  ...
  geom_point(data=g_binned,aes(x=PREVDIA,y=grow_dia,size=count_dia))+
...
grow_c_p <- ggplot(data=grdata,aes(x=PPT_yr_norm))+
  ...
  geom_point(data=g_binned,aes(x=PPT,y=grow_PPT,size=count_PPT))+
...
grow_c_t<-ggplot(data=grdata,aes(x=T_yr_norm))+
  ...
  geom_point(data=g_binned,aes(x=T,y=grow_T,size=count_T))+
...
surv_c_d <- ggplot(data=survData,aes(x=PREVDIA))+
  ...
  geom_point(data=s_binned,aes(x=PREVDIA,y=mort_dia,size=count_dia))+
...
surv_c_p <- ggplot(data=survData,aes(x=PPT_yr_norm))+
  geom_rect(aes(xmin=min(splot_data_clim$ppt),xmax=min(survData$PPT_yr_norm),
                ymin=-0.02,ymax=0.8),fill="grey80",col="grey80",alpha=0.1)+
  ...
  geom_point(data=s_binned,aes(x=PPT,y=mort_PPT,size=count_PPT))+
...
surv_c_t <- ggplot(data=survData,aes(x=T_yr_norm))+
  ...
  geom_point(data=s_binned,aes(x=T,y=mort_T,size=count_T))+
...
recr_c_p <- ggplot(data=rdata.scaled,aes(x=PPT_yr_norm))+
  ...
  geom_rect(aes(xmax=max(rplot_data_clim$ppt),xmin=max(rdata$PPT_yr_norm),
                ymin=-0.05,ymax=max(rplot_data_clim.lin$ppt_pred)),fill="grey80",col="grey80",alpha=0.1)+
  geom_point(data=r_binned,aes(x=PPT,y=recr_PPT,size=count_PPT))+
...
recr_c_t <- ggplot(data=rdata,aes(x=T_yr_norm))+
  geom_rect(aes(xmin=min(rplot_data_clim$t),xmax=min(rdata$T_yr_norm),
                ymin=-0.05,ymax=max(rplot_data_clim.lin$t_pred)),fill="grey80",col="grey80",alpha=0.1)+
  geom_rect(aes(xmax=max(rplot_data_clim$t),xmin=max(rdata$T_yr_norm),
                ymin=-0.05,ymax=max(rplot_data_clim.lin$t_pred)),fill="grey80",col="grey80",alpha=0.1)+
  geom_point(data=r_binned,aes(x=T,y=recr_T,size=count_T))+
...
grow_cc_b <- ggplot(data=grdata,aes(x=BALIVE))+
  ...
  geom_point(aes(y=-0.005),size=0.1)+
  geom_point(data=g_binned,aes(x=BALIVE,y=grow_ba,size=count_ba))+
...
surv_cc_b <- ggplot(data=survData,aes(x=BALIVE))+
  ...
  geom_point(data=s_binned,aes(x=BALIVE,y=mort_ba,size=count_ba))+
...
recr_cc_b <- ggplot(data=rdata,aes(x=BALIVE))+
  ...
  geom_point(data=r_binned,aes(x=BALIVE,y=recr_ba,size=count_ba))+
