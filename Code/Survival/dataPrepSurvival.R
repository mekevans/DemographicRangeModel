...
# Export climate data
write.csv(ppt.extr, "D:/EvansLab/Final/Data/Processed/Survival/ppt_extr.csv", row.names = F)
write.csv(tmp.extr, "D:/EvansLab/Final/Data/Processed/Survival/tmp_extr.csv", row.names = F)
write.csv(vpd.extr, "D:/EvansLab/Final/Data/Processed/Survival/vpd_extr.csv", row.names = F)
...
output <- grData_remeas[, c("CN", "PREV_TRE_CN", "PLT_CN", "PREV_PLT_CN", "LAT", "LON", "STATUSCD", "DRYBIO_AG", "PREV_DRYBIO_AG", "MEASYEAR", "PREV_MEASYEAR",
                            "CENSUS_INTERVAL", "baLive", "PPT_c", "VPD_c", "PPT_w", "VPD_w", "elev")]
write.csv(output, "D:/EvansLab/Final/Data/Processed/Survival/SurvivalData.csv", row.names = F)