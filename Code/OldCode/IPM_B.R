...
# Export
writeRaster(lambda, "D:/EvansLab/Final/Output/B/lambda.tif", overwrite = T)
writeRaster(growth, "D:/EvansLab/Final/Output/B/growth.tif", overwrite = T)
writeRaster(survival, "D:/EvansLab/Final/Output/B/survival.tif", overwrite = T)
writeRaster(reproduction, "D:/EvansLab/Final/Output/B/reproduction.tif", overwrite = T)
pdf("D:/EvansLab/Final/Output/B/Maps.pdf")
