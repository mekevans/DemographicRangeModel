...
load("D:/EvansLab/IPM/Code/Forecasts/Both/grow.rda")
load("D:/EvansLab/IPM/Code/Forecasts/Both/surv.rda")
load("D:/EvansLab/IPM/Code/Forecasts/Both/recr.rda")
load("D:/EvansLab/IPM/Code/Forecasts/Both/recrstats.rda")
...
for (i in 1:nrow(ppt_w_raster)) {
  for (j in 1:ncol(ppt_w_raster)) {
    ...
    vpd_w_val <- as.numeric(vpd_w_raster[i,j]) * 1.5
...
writeRaster(difference, "D:/EvansLab/IPM/Code/Forecasts/Both/lambdaDifference.tif", overwrite = T)
writeRaster(lambda, "D:/EvansLab/IPM/Code/Forecasts/Both/lambda.tif", overwrite = T)
writeRaster(growth, "D:/EvansLab/IPM/Code/Forecasts/Both/growth.tif", overwrite = T)
writeRaster(survival, "D:/EvansLab/IPM/Code/Forecasts/Both/survival.tif", overwrite = T)
writeRaster(reproduction, "D:/EvansLab/IPM/Code/Forecasts/Both/reproduction.tif", overwrite = T)
pdf("D:/EvansLab/IPM/Documents/Reports/ProgressReportAugust2017/Final/ForecastBoth.pdf")
