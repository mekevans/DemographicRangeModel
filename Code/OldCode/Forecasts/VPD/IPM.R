...
load("D:/EvansLab/IPM/Code/Forecasts/VPD/grow.rda")
load("D:/EvansLab/IPM/Code/Forecasts/VPD/surv.rda")
load("D:/EvansLab/IPM/Code/Forecasts/VPD/recr.rda")
load("D:/EvansLab/IPM/Code/Forecasts/VPD/recrstats.rda")
...
writeRaster(difference, "D:/EvansLab/IPM/Code/Forecasts/VPD/lambdaDifference.tif", overwrite = T)
writeRaster(lambda, "D:/EvansLab/IPM/Code/Forecasts/VPD/lambda.tif", overwrite = T)
writeRaster(growth, "D:/EvansLab/IPM/Code/Forecasts/VPD/growth.tif", overwrite = T)
writeRaster(survival, "D:/EvansLab/IPM/Code/Forecasts/VPD/survival.tif", overwrite = T)
writeRaster(reproduction, "D:/EvansLab/IPM/Code/Forecasts/VPD/reproduction.tif", overwrite = T)
pdf("D:/EvansLab/IPM/Documents/Reports/ProgressReportAugust2017/Final/ForecastVPD.pdf")
